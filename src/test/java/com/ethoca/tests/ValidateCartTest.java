...
//        System.out.println(expectedData);
    ...
    @Test(dataProvider = "ProductDetails", description = "Validate Cart contents with the test xls")
    public void validateCartDetails1(Map<Object,Object> expectedData){
//        System.out.println(expectedData);
    ...
    @Test(dataProvider = "ProductDetails", description = "Validate Cart contents with the test xls")
    public void validateCartDetails2(Map<Object,Object> expectedData){
//        System.out.println(expectedData);
        ...
        Map<String,String> actualData =paymentsPage.readCartTable();
        log.info("The actual data is : "+actualData);
        softAssert.assertEquals(actualData.get("productImageURL"),expectedData.get("productImage"),"The image URL doesn't match with the expected value");
